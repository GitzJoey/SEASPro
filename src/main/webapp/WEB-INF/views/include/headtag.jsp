<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
    ...
    <title>SEASPro - Bridging Your Education</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="seaspro, education, consultancy, singapore">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/jquery.easing/jquery.easing.1.3.js"></script>
	
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/hoverIntent/hoverIntent.js"></script>
